...
* An *outcome variable* $y$, a.k.a *dependent variable* or response variable, and
...
- We focus on modeling for explanation 
- We focus on linear regression first: the relationship between $y$ and $x$ is assumed to be linear
